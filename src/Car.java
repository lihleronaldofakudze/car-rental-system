...
public class Car {
    ...
    public void add () {
        ...
        "VALUES ("+ 0 +","+ Integer.parseInt(this.number) +", '" + this.type + "', '"+ this.category +"','"+ this.description +"','"+ this.ownerId +"')";
    ...
    public void update () {
        try {
            ...
            String sql = 
                ...
                "SET 'car_number'=" + this.number + ", 'type'='" + this.type + "', 'category'='" + this.category + "', 'description'='" + this.description + "', 'owner_id'='" + this.ownerId+ "', 'password'='" + this.password +"'"+ 
                "WHERE id=" + this.id;
            statement.executeUpdate(sql);
