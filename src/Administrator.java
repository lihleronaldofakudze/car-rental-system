...
public class Administrator {
    ...
    public static boolean login(String username, String password) {
        try {
            ...
            String query = "SELECT username, password FROM Administrators WHERE username = '" + username
    ...
    public void add() {
        try {
            ...
            String sql = "INSERT INTO Administrators (id, role_id, name, email, address, username, password)" +
                    "VALUES (" + 0 + "," + this.roleId + ", '" + this.name + "', '" + this.email + "','" + this.address
    ...
    public void update() {
        try {
            ...
            statement = connection.createStatement();
            String sql = "UPDATE Administrators SET role_id = " + this.roleId + ", name = '" + this.name
                    + "', email = '"
                    + this.email + "', address = '" + this.address + "', username = '" + this.username
                    + "', password = '"
